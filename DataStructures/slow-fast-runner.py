...
while node.next:
    node = node.next
# Here we set the end of the LinkedList to the secondd element of the initial linked list
...
def iscircular(linked_list):
    ...
    # We can only iterate if we current and next element are valid
...
#Endless circel in the linked list
